...
import { Typography, FormControlLabel, FormGroup, Switch, Button, Select, Alert, MenuItem, Box, TextField } from "@mui/material";
    ...
    return (
        ...
        <div className="basic-div basic-form">
            ...
            <form onSubmit={submitForm} className="form-group basic-group" encType="multipart/form-data">
                ...
                {
                    isApproved ?
                        <Button variant="contained" disabled={!isEditing} type="submit" className="button-group submit-button">RE-SUBMIT</Button>
                        :
                        <Button variant="contained" disabled={!isEditing} type="submit" className="button-group submit-button">SUBMIT</Button>
                }
            </form >
        </div >
